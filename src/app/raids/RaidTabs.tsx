...
const TABS = [
  { key: "settings", label: "Settings", href: (id: number) => `/raids/${id}/manage` },
  { key: "roster", label: "Roster", href: (id: number) => `/raids/lineup/${id}` },
  { key: "reserves", label: "Reserves", href: (id: number) => `/raids/reserves/${id}` },
] as const;
